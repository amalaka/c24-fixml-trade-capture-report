...
import biz.c24.io.fixml.sample.configuration.C24GemfireFlowConfiguration;
 ...
 * @since 03/04/2013
 */
public class FixmlToCompassToGemfireRunner {

    private static final Logger LOGGER = LoggerFactory.getLogger(FixmlToCompassToGemfireRunner.class);
    ...
    public static void main(String[] args) {
        ...
        new FixmlToCompassToGemfireRunner().loadSpringContainer();
    ...
    private void loadSpringContainer() {
        try {
            ...
            applicationContext.register(C24GemfireFlowConfiguration.class);
